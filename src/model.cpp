...
void s21::Calculator::IsBracketsPaired() {
    ...
    if (correctSequenceBrackets == 1) throw std::logic_error("Error: Wrong sequence or brackets!");
...
void s21::Calculator::ToRPN(const std::string& lexeme) {
    if (isdigit(lexeme[0])) { // если число
        ...
        if (token.GetPrecedence() == rBracket) { // если правая скобка
            ...
            || token.GetPrecedence() > operators_.top().GetPrecedence()) { // или токен больше чем токен в операх
            operators_.push(token);
        } else if (token.GetPrecedence() <= operators_.top().GetPrecedence()) { // если токен меньше или равен оперному
            while (!operators_.empty()) { 
...
void s21::Calculator::CreateTokenMap() {
    std::initializer_list<std::pair<const std::string, s21::Token>> list = {
        ...
        {"cos", s21::Token("cos", s21::Precedence::Ultra, s21::Associativity::Right,
                         s21::Type::oUnary, cosl)},
        {"sin", s21::Token("sin", s21::Precedence::Ultra, s21::Associativity::Right,
                         s21::Type::oUnary, sinl)},
        {"tan", s21::Token("tan", s21::Precedence::Ultra, s21::Associativity::Right,
                         s21::Type::oUnary, tanl)},
        {"acos", s21::Token("acos", s21::Precedence::Ultra, s21::Associativity::Right,
                         s21::Type::oUnary, acosl)},
        {"asin", s21::Token("asin", s21::Precedence::Ultra, s21::Associativity::Right,
                         s21::Type::oUnary, asinl)},
        {"atan", s21::Token("atan", s21::Precedence::Ultra, s21::Associativity::Right,
                         s21::Type::oUnary, atanl)},
        {"sqrt", s21::Token("sqrt", s21::Precedence::Ultra, s21::Associativity::Right,
                         s21::Type::oUnary, sqrtl)},
        {"ln", s21::Token("ln", s21::Precedence::Ultra, s21::Associativity::Right,
                         s21::Type::oUnary, logl)},
        {"log", s21::Token("log", s21::Precedence::Ultra, s21::Associativity::Right,
                         s21::Type::oUnary, log10l)},
        {"mod", s21::Token("mod", s21::Precedence::Medium, s21::Associativity::Left,
                         s21::Type::oBinary, fmodl)},
